                ...
                <div class="container container-header">
                                ...
                                <li><a href="about.html#">Home</a>
                                    <ul>
                                        ...
                                        <li><a href="about.html#">Home Image</a>
                                            ...
                                            <li><a href="about.html#">Home Video</a>
                                                <ul>
                                            ...
                                            <li><a href="about.html#">Home Slider</a>
                                                <ul>                                                    
                                            ...
                                            <li><a href="about.html#">Home Styles</a>
                                                <ul>
                                    ...
                                    <li><a href="about.html#">Listing</a>
                                        <ul>
                                            <li><a href="about.html#">Listing Grid</a>
                                                <ul>
                                            ...
                                            <li><a href="about.html#">Listing List</a>
                                                <ul>
                                            ...
                                            <li><a href="about.html#">Listing Map</a>
                                                <ul>
                                            ...
                                            <li><a href="about.html#">Agent View</a>
                                                <ul>
                                            ...
                                            <li><a href="about.html#">Agencies View</a>
                                                <ul>
                                    ...
                                    <li><a href="about.html#">Property</a>
                                        <ul>
                                    ...
                                    <li><a href="about.html#">Pages</a>
                                        <ul>
                                            ...
                                            <li><a href="about.html#">User Panel</a>
                                                <ul>
                                    ...
                                    <li><a href="about.html#">Blog</a>
                                        <ul>
                                            <li><a href="about.html#">Grid Layout</a>
                                                <ul>
                                                    <li><a href="blog-full-grid.html">Full Grid</a></li>
                                                    <li><a href="blog-grid-sidebar.html">With Sidebar</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="about.html#">List Layout</a>
                                                <ul>
                    ...
                    <div class="right-side d-none d-none d-lg-none d-xl-flex sign ml-0">
                        ...
                        <div class="header-widget sign-in">
                            <div class="show-reg-form modal-open"><a href="about.html#">Sign In</a></div>
                        </div>
                        <!-- Header Widget / End -->
                    </div>
                    <!-- Right Side Content / End -->
                    ...
                    <div class="header-user-menu user-menu add d-none d-lg-none d-xl-flex">
                        <div class="lang-wrap">
                            ...
                            <ul class="lang-tooltip lang-action no-list-style">
                                <li><a href="about.html#" class="current-lan" data-lantext="En">English</a></li>
                                <li><a href="about.html#" data-lantext="Fr">Francais</a></li>
                                <li><a href="about.html#" data-lantext="Es">Espanol</a></li>
                                <li><a href="about.html#" data-lantext="De">Deutsch</a></li>
                            </ul>
                        </div>
                    </div>
                    <!-- lang-wrap end-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 who-1">
                        <div>
                            <h2 class="text-left mb-4">About Fountainprimehomes</h2>
                        </div>
                        <div class="pftext">
                            <p>Fountain Prime Homes presents a mix of contemporary, class and smart homes in an ambient environment. It comprises of two varieties of terrace housing units, which are, four bedroom terraces and two bedroom terraces, all on two suspended floors. The accommodations in this estate will be fitted with gadgets to make it truly smart as well as pre-installed internet fibre-optic backbone to power these devices.</p>

                            <p>Fountain Prime elite residents are assured of round-the-clock power and water supply, access to the estate’s outdoor swimming pool and gym, and a fully equipped security post. Unlike many other real estate themes which confine their residents to a life of constraints, Fountain Prime enables you remain fully informed with automated notifications and workflows from the Fountain Prime Mobile App.</p>
                        </div>
                        <div class="box bg-2">
                            ...
                            <div class="team-content">
                                <div class="team-info">
                                    ...
                                    <div class="team-socials">
                                        <ul>
                                            <li>
                                                <a href="about.html#" title="facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                                <a href="about.html#" title="twitter"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                                <a href="about.html#" title="instagran"><i class="fa fa-instagram" aria-hidden="true"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                    <span><a href="https://code-theme.com/html/findhouses/team-details.html">View Profile</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="navigation">
                                ...
                                <div class="nav-footer">
                                    <ul>
                                        ...
                                        <li><a href="https://code-theme.com/html/findhouses/properties-full-list.html">Properties List</a></li>
                                        <li><a href="https://code-theme.com/html/findhouses/properties-details.html">Property Details</a></li>
                                        <li class="no-mgb"><a href="agents-listing-grid.html">Agents Listing</a></li>
                                    </ul>
                                    <ul class="nav-right">
                                        <li><a href="agent-details.html">Agents Details</a></li>
                                        <li><a href="about.html">About Us</a></li>
                                        <li><a href="https://code-theme.com/html/findhouses/blog.html">Blog Default</a></li>
                                        <li><a href="blog-details.html">Blog Details</a></li>
                                ...
                                <div class="twitter-widget contuct">
                                    <div class="twitter-area">
                                        <div class="single-item">
                                            ...
                                            <div class="text">
                                                <h5><a href="about.html#">@findhouses</a> all share them with me baby said inspet.</h5>
            ...
            <div class="second-footer">
                <div class="container">
                    ...
                    <ul class="netsocials">
                        ...
                        <li><a href="about.html#"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
            </div>
        </footer>

        <a data-scroll href="about.html#wrapper" class="go-up"><i class="fa fa-angle-double-up" aria-hidden="true"></i></a>
        <!-- END FOOTER -->
            ...
            <div class="main-register-holder">
                <div class="main-register fl-wrap">
                    ...
                    <div class="soc-log fl-wrap">
                        <p>Login</p>
                        <a href="about.html#" class="facebook-log"><i class="fa fa-facebook-official"></i>Log in with Facebook</a>
                        <a href="about.html#" class="twitter-log"><i class="fa fa-twitter"></i> Log in with Twitter</a>
                    </div>
                    <div class="log-separator fl-wrap"><span>Or</span></div>
                    <div id="tabs-container">
                        <ul class="tabs-menu">
                            <li class="current"><a href="about.html#tab-1">Login</a></li>
                            <li><a href="about.html#tab-2">Register</a></li>
                        </ul>
                        <div class="tab">
                            <div id="tab-1" class="tab-contents">
                                <div class="custom-form">
                                    ...
                                    <div class="lost_password">
                                        <a href="about.html#">Lost Your Password?</a>
                                    </div>
                                </div>
                            </div>
                            <div class="tab">
