...
class OkoyeException extends \Exception
{
    protected $message = '';
    protected $isError = false;

    public function __construct($message = 'Okoye_Error', $code = 0, $isError = false)
    {
    ...
    public static function errorHandler($errno, $errstr, $errfile, $errline, $errcontext)
    {
        ...
        $error_names = [
            ...
            // A fatal error generated by Okoye. Code execution is stopped.
            E_USER_ERROR        => 'User Error',
            // A non-fatal error generated by Okoye. Code execution is not stopped.
            E_USER_WARNING      => 'User Warning',
            // PHP encountered something generated by Okoye at runtime that could be an error or intended
        ...
        if (version_compare(PHP_VERSION, '5.6', '>=')) {
            ...
            // A notification that the code is outdated and Okoye may not work with it in the future
